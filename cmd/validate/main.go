...
import (
	...
	"github.com/jhannah/kin-openapi/openapi2"
...
func main() {
	...
	if len(flag.Args()) != 1 || filename == "" {
		log.Fatalf("Usage: go run github.com/jhannah/kin-openapi/cmd/validate@latest [--defaults] [--examples] [--ext] [--patterns] -- <local YAML or JSON file>\nGot: %+v\n", os.Args)
	}
